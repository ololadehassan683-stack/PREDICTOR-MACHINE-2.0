...
<div class="section">
  ...
  <div class="match">Barcelona vs Valencia</div>
  <div class="match">Inter vs Bologna</div>
  <div class="match">PSG vs Nantes</div>
  <div class="total-odds">TOTAL ODDS = 1.30 ✅</div>
</div>

<!-- 1.50+ Section -->
<div class="section">
  <h2>Rollover 1.50+ Odds</h2>
  <div class="match">Arsenal vs Burnley</div>
  <div class="match">Bayern vs Mainz</div>
  <div class="total-odds">TOTAL ODDS = 1.55 ✅</div>
</div>

<!-- 2.00+ Section -->
<div class="section">
  <h2>Rollover 2.00+ Odds</h2>
  <div class="match">Real Madrid vs Atletico</div>
  <div class="match">Milan vs Napoli</div>
  <div class="total-odds">TOTAL ODDS = 2.05 ✅</div>
</div>
